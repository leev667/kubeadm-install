...
#kubeadm init --pod-network-cidr=192.168.0.0/16 --apiserver-advertise-address=10.0.1.72 | tee kubeadm-init.out

read -p "Enter token: " token
read -p "Enter discovery-token-ca-cert-hash: " cert_hash
